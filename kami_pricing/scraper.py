...
class Scraper:
    def __init__(self, marketplace: str, products_urls: List[str] = None):
    ...
    def scrap_products_from_marketplace(self) -> List[str]:
        try:
            ...
            for url in self.products_urls[0]:
        ...
        for i in hairpro_df['sku']:
            for j in except_hairpro_df['sku']:
                ...
                if (
                    ...
                    scraper_logger.info(difference_price_df['suggest_price'])
